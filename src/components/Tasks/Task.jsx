...
const Task = ({id, text, attitude, listId, onChangeAttitudeTask}) => {
        ...
        <div className="tasks__items-row">
            <div className="tasks__items-row-attitude">
                ...
                <>
                    ...
                    <input onClick={handleChange} id={`task-${id}-l`} type="button"/>
                </>
                }
                {attitude !== 'ready_tasks' &&
                <>
                    <input onClick={handleChange} id={`task-${id}-r`} type="button"/>
