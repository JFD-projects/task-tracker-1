...
const Task = ({id, text, completed, onRemove, onEdit, listId, onCompleteTasks}) => {
    const handleChange =({target})=>{
        onCompleteTasks(listId, id, target.checked)
    }
    return (
        <div className="tasks__items-row">
            <div className="checkbox" >
                <input onClick={handleChange} id={`task-${id}`} checked={completed} type="checkbox" readOnly/>
            ...
            <div className="tasks__items-row-actions">
                ...
                <div  onClick={()=>onRemove(listId, id)}>
